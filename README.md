...
See [deploying Cloud Foundry documentation](http://docs.cloudfoundry.org/deploying/boshlite/deploy_cf_boshlite.html) for detailed instructions. Alternatively check out https://github.com/cloudfoundry/cf-release as `~/workspace/cf-release` and run `./bin/provision_cf` from this repository.
